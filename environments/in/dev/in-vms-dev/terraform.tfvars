...
# in the output of `terraform apply` inside environments/in/dev/in-host-dev-network).
project_id      = "vms-dev-501607" # in-vms-dev
region          = "asia-south1"
host_project_id = "host-dev-network" # in-host-dev-network

host_vpc_id           = "projects/host-dev-network/global/networks/india-dev-vpc"
host_subnet_self_link = "projects/host-dev-network/regions/asia-south1/subnetworks/vms-dev-private"
