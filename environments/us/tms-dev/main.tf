# =================================================================
# ENVIRONMENT: us/tms-dev   (service project: us-tms-dev)
#
# Deploys into the Shared VPC owned by us/host-dev.
...
# created by us/host-dev. If you're not sure what a subnet
...
# from the secondary ranges that us/host-dev already reserved
