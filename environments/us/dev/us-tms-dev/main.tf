# =================================================================
# ENVIRONMENT: us/dev/us-tms-dev   (service project: us-tms-dev)
#
# Deploys into the Shared VPC owned by us/dev/us-host-dev-network.
...
# created by us/dev/us-host-dev-network. If you're not sure what a subnet
...
resource "google_compute_global_address" "private_ip_alloc" {
  name          = "us-tms-dev-private-ip-alloc"
  purpose       = "VPC_PEERING"
...
# from the secondary ranges that us/dev/us-host-dev-network already reserved
...
module "db_secret" {
  ...
  project_id   = var.project_id
  secret_name  = "us-tms-dev-db-password"
